...
CREATE TABLE interest_rate (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_interest_product FOREIGN KEY (product_id) REFERENCES products(product_id)
);
...
-- Insert base rates for each FD product
INSERT INTO interest_rate (product_id, base_rate) VALUES
(1, 5.50),  -- SmartSaver FD
(2, 6.50),  -- GoldenYears FD
(3, 6.00),  -- TaxShield FD
(4, 5.75),  -- FlexiGain FD
(5, 5.25),  -- StepUp FD
(6, 6.75);  -- GlobalConnect FD

-- SmartSaver FD (Product 1)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(1, 'Regular', 30, 180, 5.50, 7.50),
(1, 'Senior Citizen', 30, 180, 6.50, 7.50),
(1, 'NRI', 30, 180, 6.00, 7.50),
(1, 'Regular', 181, 365, 5.75, 7.50),
(1, 'Senior Citizen', 181, 365, 6.75, 7.50),
(1, 'NRI', 181, 365, 6.25, 7.50);

-- GoldenYears FD (Product 2)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(2, 'Regular', 30, 180, 6.50, 8.50),
(2, 'Senior Citizen', 30, 180, 7.00, 8.50),
(2, 'NRI', 30, 180, 6.75, 8.50),
(2, 'Regular', 181, 365, 6.75, 8.50),
(2, 'Senior Citizen', 181, 365, 7.25, 8.50),
(2, 'NRI', 181, 365, 7.00, 8.50);

-- TaxShield FD (Product 3)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(3, 'Regular', 365, 1825, 6.00, 8.00),
(3, 'Senior Citizen', 365, 1825, 6.50, 8.00),
(3, 'NRI', 365, 1825, 6.25, 8.00);

-- FlexiGain FD (Product 4)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(4, 'Regular', 30, 365, 5.75, 7.75),
(4, 'Senior Citizen', 30, 365, 6.25, 7.75),
(4, 'NRI', 30, 365, 6.00, 7.75);

-- StepUp FD (Product 5)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(5, 'Regular', 30, 365, 5.25, 7.25),
(5, 'Senior Citizen', 30, 365, 5.75, 7.25),
(5, 'NRI', 30, 365, 5.50, 7.25);

-- GlobalConnect FD (Product 6)
INSERT INTO rate_matrix (product_id, customer_category, min_term, max_term, interest_rate, rate_cap) VALUES
(6, 'Regular', 30, 365, 6.75, 8.75),
(6, 'Senior Citizen', 30, 365, 7.25, 8.75),
(6, 'NRI', 30, 365, 7.00, 8.75);
