...
(product_code, product_name, product_type, effective_date, expiry_date, branch, currency, status, description)
VALUES
('FD001', 'SmartSaver FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'INR', 'Active', 'Standard FD for general customers'),
('FD002', 'GoldenYears FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'INR', 'Active', 'Special FD scheme for senior citizens with higher interest rates'),
('FD003', 'TaxShield FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'INR', 'Active', 'Tax-saving FD with 5-year lock-in under Section 80C'),
('FD004', 'FlexiGain FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'INR', 'Active', 'Flexi deposit linked with savings/current account balance'),
('FD005', 'StepUp FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'INR', 'Active', 'Recurring deposit that converts into lump-sum FD at maturity'),
('FD006', 'GlobalConnect FD', 'Fixed Deposit', '2025-10-01', NULL, 'Main Branch', 'USD', 'Active', 'NRI FD product with repatriation benefits');
